...
{
    public partial class DoorAccess : Form
    {
        ...
        protected virtual void DoorAccess_OnClosing(object sender, CancelEventArgs e)
        {
        ...
        private void DoorAccess_Load(object sender, EventArgs e)
        {
            Assembly assembly;
